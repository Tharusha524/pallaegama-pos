...
import { getClassType, updateClassType } from "../../../../api/GLAccounts/ClassTypeApi";
...
export default function UpdateClassTypeForm() {
  ...
  useEffect(() => {
    if (id) {
      getClassType(id).then((res) => setFormData(res));
    }
  }, [id]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      await updateClassType(id, formData);
  ...
  return (
    <FormPageLayout>
      ...
      <UpdateConfirmationModal
        open={open}
        title="Success"
        content="Class Type has been updated successfully!"
