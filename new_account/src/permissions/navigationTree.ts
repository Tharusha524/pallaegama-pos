    ...
    submenus: [
      {
        ...
        pages: [
          ...
          { label: "Quick Stock Receive", id: id("Supermarket quick stock receive"), path: "/supermarket/quick-stock-receive" },
          { label: "Suppliers", id: id("Supermarket suppliers"), path: "/supermarket/suppliers" },
